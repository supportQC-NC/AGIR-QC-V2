// // src/components/Admin/OutilDocumentationModal.jsx
...
// import "./OutilDocumentationModal.css";
...
// const OutilDocumentationModal = ({ outil, onClose }) => {
...
//   const { data: outilData, refetch } = useGetOutilByIdQuery(outil._id);
//   const [addDoc, { isLoading: isAdding }] = useAddDocumentationMutation();
//   const [updateDoc, { isLoading: isUpdating }] =
//     useUpdateDocumentationMutation();
//   const [deleteDoc, { isLoading: isDeleting }] =
//     useDeleteDocumentationMutation();

//   const documentation = outilData?.documentation || outil.documentation || [];
...
//       try {
//         await deleteDoc({ outilId: outil._id, docId }).unwrap();
//         refetch();
//       } catch (err) {
...
//       window.open(
//         `/api/outils/${outil._id}/documentation/${doc._id}`,
//         "_blank",
//       );
//     }
//   };
...
//           <h2>
//             <HiDocumentText /> Documentation - {outil.titre}
//           </h2>
...
//                       />
//                       <label htmlFor="doc-file" className="file-upload-btn">
//                         <HiUpload />
//                         <span>
//                           {file
//                             ? file.name
...
// export default OutilDocumentationModal;
...
const OutilDocumentationModal = ({ outil, onClose }) => {
  ...
  // Tri sécurisé avec clone pour éviter la mutation
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingDoc) {
        ...
        await addDoc({ outilId: outil._id, formData: submitData }).unwrap();
      }
...
const openDocument = (doc) => {
  if (doc.type === "lien") {
    ...
    const apiUrl = process.env.REACT_APP_API_URL || ""; // fallback vide
    window.open(
      `${apiUrl}/api/outils/${outil._id}/documentation/${doc._id}`,
      "_blank"
    );
  }
};
